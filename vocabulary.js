...
verbs: [
  // Common B1 verbs
  {spanish: "hablar", english: "to speak", example: {spanish: "Ella habla tres idiomas con fluidez.", english: "She speaks three languages fluently."}},
  {spanish: "comer", english: "to eat", example: {spanish: "Vamos a comer paella este domingo.", english: "We're going to eat paella this Sunday."}},
  {spanish: "beber", english: "to drink", example: {spanish: "Es importante beber suficiente agua.", english: "It's important to drink enough water."}},
  {spanish: "vivir", english: "to live", example: {spanish: "Mis abuelos viven en el campo.", english: "My grandparents live in the countryside."}},
  {spanish: "trabajar", english: "to work", example: {spanish: "Trabajo como ingeniero en una empresa multinacional.", english: "I work as an engineer in a multinational company."}},
  {spanish: "estudiar", english: "to study", example: {spanish: "Estudio medicina en la universidad.", english: "I study medicine at university."}},
  {spanish: "aprender", english: "to learn", example: {spanish: "Aprendo español con una aplicación.", english: "I learn Spanish with an app."}},
  {spanish: "enseñar", english: "to teach", example: {spanish: "Mi madre enseña matemáticas en el instituto.", english: "My mother teaches math in high school."}},
  {spanish: "comprar", english: "to buy", example: {spanish: "Voy a comprar pan en la panadería.", english: "I'm going to buy bread at the bakery."}},
  {spanish: "vender", english: "to sell", example: {spanish: "Venden frutas frescas en el mercado.", english: "They sell fresh fruits at the market."}},
  {spanish: "pagar", english: "to pay", example: {spanish: "Pagué la cena con tarjeta de crédito.", english: "I paid for dinner with a credit card."}},
  {spanish: "gastar", english: "to spend", example: {spanish: "No quiero gastar mucho dinero en ropa.", english: "I don't want to spend much money on clothes."}},
  {spanish: "ahorrar", english: "to save (money)", example: {spanish: "Estamos ahorrando para comprar una casa.", english: "We're saving to buy a house."}},
  {spanish: "ganar", english: "to win/earn", example: {spanish: "Ganó el premio al mejor jugador.", english: "He won the best player award."}},
  {spanish: "perder", english: "to lose", example: {spanish: "Perdí mis llaves en el parque.", english: "I lost my keys in the park."}},
  
  // Irregular but common B1 verbs
  {spanish: "ir", english: "to go", example: {spanish: "Voy al cine con mis amigos.", english: "I'm going to the movies with my friends."}},
  {spanish: "ser", english: "to be (permanent)", example: {spanish: "Soy profesor de inglés.", english: "I am an English teacher."}},
  {spanish: "estar", english: "to be (temporary)", example: {spanish: "Estoy cansado después del trabajo.", english: "I'm tired after work."}},
  {spanish: "tener", english: "to have", example: {spanish: "Tengo dos hermanos menores.", english: "I have two younger brothers."}},
  {spanish: "hacer", english: "to do/make", example: {spanish: "Hago ejercicio todas las mañanas.", english: "I exercise every morning."}},
  {spanish: "decir", english: "to say/tell", example: {spanish: "Dime qué quieres para tu cumpleaños.", english: "Tell me what you want for your birthday."}},
  {spanish: "venir", english: "to come", example: {spanish: "Mis primos vienen a visitarnos este verano.", english: "My cousins are coming to visit us this summer."}},
  {spanish: "poner", english: "to put/place", example: {spanish: "Pon los libros en la estantería.", english: "Put the books on the shelf."}},
  {spanish: "salir", english: "to leave/go out", example: {spanish: "Salimos a cenar los viernes.", english: "We go out for dinner on Fridays."}},
  {spanish: "ver", english: "to see", example: {spanish: "Veo una película cada semana.", english: "I watch a movie every week."}},
  {spanish: "dar", english: "to give", example: {spanish: "Le di un regalo a mi madre.", english: "I gave my mother a present."}},
  {spanish: "saber", english: "to know (facts)", example: {spanish: "Sé que Madrid es la capital de España.", english: "I know that Madrid is the capital of Spain."}},
  {spanish: "conocer", english: "to know (people/places)", example: {spanish: "Conozco bien Barcelona porque viví allí.", english: "I know Barcelona well because I lived there."}},
  {spanish: "poder", english: "to be able to/can", example: {spanish: "Puedo ayudarte con tu tarea.", english: "I can help you with your homework."}},
  {spanish: "querer", english: "to want", example: {spanish: "Quiero aprender a bailar salsa.", english: "I want to learn to dance salsa."}},
  
  // Daily activities B1-B2
  {spanish: "despertarse", english: "to wake up", example: {spanish: "Me despierto a las 7 cada mañana.", english: "I wake up at 7 every morning."}},
  {spanish: "levantarse", english: "to get up", example: {spanish: "Se levanta temprano para ir al gimnasio.", english: "He gets up early to go to the gym."}},
  {spanish: "ducharse", english: "to shower", example: {spanish: "Me ducho con agua fría en verano.", english: "I shower with cold water in summer."}},
  {spanish: "vestirse", english: "to get dressed", example: {spanish: "Los niños se visten solos para la escuela.", english: "The children get dressed by themselves for school."}},
  {spanish: "desayunar", english: "to have breakfast", example: {spanish: "Desayunamos tostadas con café.", english: "We have toast with coffee for breakfast."}},
  {spanish: "almorzar", english: "to have lunch", example: {spanish: "Almorzamos a la una en punto.", english: "We have lunch at one o'clock."}},
  {spanish: "cenar", english: "to have dinner", example: {spanish: "Cenamos pescado los viernes.", english: "We have fish for dinner on Fridays."}},
  {spanish: "dormirse", english: "to fall asleep", example: {spanish: "El bebé se durmió en el coche.", english: "The baby fell asleep in the car."}},
  {spanish: "acostarse", english: "to go to bed", example: {spanish: "Me acuesto temprano durante la semana.", english: "I go to bed early during the week."}},
  {spanish: "preparar", english: "to prepare", example: {spanish: "Preparamos la maleta para el viaje.", english: "We prepare the suitcase for the trip."}},
  {spanish: "cocinar", english: "to cook", example: {spanish: "Mi padre cocina los domingos.", english: "My father cooks on Sundays."}},
  {spanish: "limpiar", english: "to clean", example: {spanish: "Limpié toda la casa antes de la fiesta.", english: "I cleaned the whole house before the party."}},
  {spanish: "lavar", english: "to wash", example: {spanish: "Lavo la ropa los sábados por la mañana.", english: "I wash clothes on Saturday mornings."}},
  {spanish: "planchar", english: "to iron", example: {spanish: "Plancho las camisas para el trabajo.", english: "I iron shirts for work."}},
  
  // Communications B1-B2
  {spanish: "llamar", english: "to call", example: {spanish: "Llama a tu madre cuando llegues.", english: "Call your mother when you arrive."}},
  {spanish: "contestar", english: "to answer", example: {spanish: "No contestó el teléfono cuando llamé.", english: "He didn't answer the phone when I called."}},
  {spanish: "preguntar", english: "to ask", example: {spanish: "Pregunté por el precio del coche.", english: "I asked about the car's price."}},
  {spanish: "responder", english: "to respond", example: {spanish: "El profesor respondió a todas nuestras dudas.", english: "The teacher responded to all our questions."}},
  {spanish: "explicar", english: "to explain", example: {spanish: "Explíqueme cómo funciona esta máquina.", english: "Explain to me how this machine works."}},
  {spanish: "describir", english: "to describe", example: {spanish: "Describió el paisaje con mucho detalle.", english: "He described the landscape in great detail."}},
  {spanish: "charlar", english: "to chat", example: {spanish: "Charlamos durante horas en el café.", english: "We chatted for hours at the café."}},
  {spanish: "discutir", english: "to discuss/argue", example: {spanish: "Discutieron sobre política durante la cena.", english: "They argued about politics during dinner."}},
  {spanish: "negociar", english: "to negotiate", example: {spanish: "Negociaron un mejor precio para el contrato.", english: "They negotiated a better price for the contract."}},
  {spanish: "enviar", english: "to send", example: {spanish: "Envié un paquete a mi hermana.", english: "I sent a package to my sister."}},
  {spanish: "recibir", english: "to receive", example: {spanish: "Recibí una carta del banco hoy.", english: "I received a letter from the bank today."}},
  {spanish: "entender", english: "to understand", example: {spanish: "Entiendo perfectamente lo que dices.", english: "I understand perfectly what you're saying."}},
  {spanish: "malinterpretar", english: "to misunderstand", example: {spanish: "Malinterpreté sus intenciones al principio.", english: "I misunderstood his intentions at first."}},
  {spanish: "confundir", english: "to confuse", example: {spanish: "Confundí tu número de teléfono con el de tu hermano.", english: "I confused your phone number with your brother's."}},
  
  // Action verbs B1-B2
  {spanish: "correr", english: "to run", example: {spanish: "Corro en el parque cada mañana.", english: "I run in the park every morning."}},
  {spanish: "caminar", english: "to walk", example: {spanish: "Caminamos por la playa al atardecer.", english: "We walked along the beach at sunset."}},
  {spanish: "nadar", english: "to swim", example: {spanish: "Nadamos en la piscina del hotel.", english: "We swam in the hotel pool."}},
  {spanish: "saltar", english: "to jump", example: {spanish: "El niño saltó de alegría cuando ganó.", english: "The boy jumped for joy when he won."}},
  {spanish: "caer", english: "to fall", example: {spanish: "Se cayó mientras patinaba en el hielo.", english: "He fell while ice skating."}},
  {spanish: "subir", english: "to go up/climb", example: {spanish: "Subimos la montaña en cuatro horas.", english: "We climbed the mountain in four hours."}},
  {spanish: "bajar", english: "to go down/descend", example: {spanish: "Bajamos las escaleras rápidamente.", english: "We went down the stairs quickly."}},
  {spanish: "empujar", english: "to push", example: {spanish: "Empujamos el coche cuando se quedó sin gasolina.", english: "We pushed the car when it ran out of gas."}},
  {spanish: "tirar", english: "to pull/throw", example: {spanish: "Tiró la pelota al perro para que la atrapara.", english: "He threw the ball to the dog to catch it."}},
  {spanish: "abrir", english: "to open", example: {spanish: "Abrió la puerta con mucha cautela.", english: "He opened the door very cautiously."}},
  {spanish: "cerrar", english: "to close", example: {spanish: "Cierra la ventana que hace frío.", english: "Close the window, it's cold."}},
  {spanish: "entrar", english: "to enter", example: {spanish: "Entramos al museo sin hacer fila.", english: "We entered the museum without waiting in line."}},
  {spanish: "salir", english: "to exit/leave", example: {spanish: "Salieron del restaurante a medianoche.", english: "They left the restaurant at midnight."}},
  {spanish: "llegar", english: "to arrive", example: {spanish: "Llegamos tarde a la reunión por el tráfico.", english: "We arrived late to the meeting because of traffic."}},
  {spanish: "partir", english: "to depart", example: {spanish: "El tren parte a las 8 en punto.", english: "The train departs at 8 o'clock."}},
  
  // B2 level verbs
  {spanish: "considerar", english: "to consider", example: {spanish: "Considero que es una buena oportunidad.", english: "I consider it a good opportunity."}},
  {spanish: "suponer", english: "to suppose/assume", example: {spanish: "Supongo que llegarán tarde como siempre.", english: "I suppose they'll arrive late as usual."}},
  {spanish: "recordar", english: "to remember", example: {spanish: "Recuerdo perfectamente ese día.", english: "I remember that day perfectly."}},
  {spanish: "olvidar", english: "to forget", example: {spanish: "Olvidé comprar leche en el supermercado.", english: "I forgot to buy milk at the supermarket."}},
  {spanish: "convertir", english: "to convert/transform", example: {spanish: "Convertimos el ático en una oficina.", english: "We converted the attic into an office."}},
  {spanish: "desarrollar", english: "to develop", example: {spanish: "La empresa desarrolla software educativo.", english: "The company develops educational software."}},
  {spanish: "mejorar", english: "to improve", example: {spanish: "Mi español mejora cada día.", english: "My Spanish improves every day."}},
  {spanish: "empeorar", english: "to worsen", example: {spanish: "El tiempo empeoró durante la tarde.", english: "The weather worsened during the afternoon."}},
  {spanish: "mantener", english: "to maintain/keep", example: {spanish: "Mantengo contacto con mis amigos de la infancia.", english: "I keep in touch with my childhood friends."}},
  {spanish: "cambiar", english: "to change", example: {spanish: "Cambié de opinión después de pensarlo.", english: "I changed my mind after thinking about it."}},
  {spanish: "crear", english: "to create", example: {spanish: "Creó una obra de arte increíble.", english: "He created an amazing work of art."}},
  {spanish: "destruir", english: "to destroy", example: {spanish: "El incendio destruyó el edificio histórico.", english: "The fire destroyed the historic building."}},
  {spanish: "construir", english: "to build/construct", example: {spanish: "Construyeron un nuevo centro comercial.", english: "They built a new shopping center."}},
  {spanish: "establecer", english: "to establish", example: {spanish: "Establecimos nuevas reglas para el equipo.", english: "We established new rules for the team."}},
  {spanish: "permitir", english: "to permit/allow", example: {spanish: "No permiten fumar en este restaurante.", english: "They don't allow smoking in this restaurant."}},
  {spanish: "prohibir", english: "to prohibit/forbid", example: {spanish: "Prohíben el uso de teléfonos en clase.", english: "They prohibit the use of phones in class."}},
  {spanish: "intentar", english: "to try/attempt", example: {spanish: "Intenté llamarte varias veces.", english: "I tried to call you several times."}},
  {spanish: "lograr", english: "to achieve", example: {spanish: "Logró su objetivo después de mucho esfuerzo.", english: "He achieved his goal after much effort."}},
  {spanish: "fallar", english: "to fail", example: {spanish: "Fallé en mi intento de hacer el pastel.", english: "I failed in my attempt to make the cake."}},
  
  // Cognitive B2-C1
  {spanish: "pensar", english: "to think", example: {spanish: "Pienso mucho antes de tomar decisiones.", english: "I think a lot before making decisions."}},
  {spanish: "creer", english: "to believe", example: {spanish: "Creo que es la mejor solución.", english: "I believe it's the best solution."}},
  {spanish: "dudar", english: "to doubt", example: {spanish: "Dudo que pueda venir a la fiesta.", english: "I doubt I can come to the party."}},
  {spanish: "reflexionar", english: "to reflect/ponder", example: {spanish: "Reflexioné sobre lo que me dijiste.", english: "I reflected on what you told me."}},
  {spanish: "analizar", english: "to analyze", example: {spanish: "Analizamos los resultados del experimento.", english: "We analyzed the experiment's results."}},
  {spanish: "evaluar", english: "to evaluate", example: {spanish: "Evaluaron todas las opciones posibles.", english: "They evaluated all possible options."}},
  {spanish: "comparar", english: "to compare", example: {spanish: "Comparé varios modelos antes de comprar.", english: "I compared several models before buying."}},
  {spanish: "contrastar", english: "to contrast", example: {spanish: "Contrastamos las dos teorías en el ensayo.", english: "We contrasted the two theories in the essay."}},
  {spanish: "deducir", english: "to deduce", example: {spanish: "Deduje la respuesta por el contexto.", english: "I deduced the answer from the context."}},
  {spanish: "inferir", english: "to infer", example: {spanish: "Podemos inferir sus intenciones por sus acciones.", english: "We can infer his intentions from his actions."}},
  {spanish: "concluir", english: "to conclude", example: {spanish: "Concluyó su discurso con un mensaje esperanzador.", english: "He concluded his speech with a hopeful message."}},
  {spanish: "percibir", english: "to perceive", example: {spanish: "Percibí un cambio en su actitud.", english: "I perceived a change in his attitude."}},
  {spanish: "intuir", english: "to intuit", example: {spanish: "Intuyo que algo no está bien.", english: "I intuit that something isn't right."}},
  {spanish: "imaginar", english: "to imagine", example: {spanish: "Imagina un mundo sin guerras.", english: "Imagine a world without wars."}},
  {spanish: "soñar", english: "to dream", example: {spanish: "Soñé que volaba sobre las nubes.", english: "I dreamed I was flying above the clouds."}},
  {spanish: "interpretar", english: "to interpret", example: {spanish: "Interpretó la canción de manera única.", english: "She interpreted the song in a unique way."}},
  
  // Professional/Business C1
  {spanish: "gestionar", english: "to manage", example: {spanish: "Gestionó el proyecto con gran eficiencia.", english: "He managed the project with great efficiency."}},
  {spanish: "coordinar", english: "to coordinate", example: {spanish: "Coordina el equipo de marketing internacional.", english: "She coordinates the international marketing team."}},
  {spanish: "delegar", english: "to delegate", example: {spanish: "Aprendí a delegar tareas a mi equipo.", english: "I learned to delegate tasks to my team."}},
  {spanish: "supervisar", english: "to supervise", example: {spanish: "Supervisa la producción en la fábrica.", english: "He supervises production at the factory."}},
  {spanish: "implementar", english: "to implement", example: {spanish: "Implementamos un nuevo sistema de gestión.", english: "We implemented a new management system."}},
  {spanish: "administrar", english: "to administer", example: {spanish: "Administra una cartera de clientes importantes.", english: "He administers a portfolio of important clients."}},
  {spanish: "dirigir", english: "to direct/lead", example: {spanish: "Dirige la compañía desde hace diez años.", english: "He has led the company for ten years."}},
  {spanish: "presidir", english: "to preside over", example: {spanish: "Presidió la reunión anual de accionistas.", english: "She presided over the annual shareholders meeting."}},
  {spanish: "representar", english: "to represent", example: {spanish: "Representa a nuestra empresa en el extranjero.", english: "He represents our company abroad."}},
  {spanish: "invertir", english: "to invest", example: {spanish: "Invertimos en propiedades en la costa.", english: "We invested in properties on the coast."}},
  {spanish: "financiar", english: "to finance", example: {spanish: "El banco financió nuestra expansión.", english: "The bank financed our expansion."}},
  {spanish: "rentabilizar", english: "to make profitable", example: {spanish: "Rentabilizamos el negocio en dos años.", english: "We made the business profitable in two years."}},
  {spanish: "facturar", english: "to bill/invoice", example: {spanish: "Facturamos el servicio el primer día de cada mes.", english: "We bill for the service on the first day of each month."}},
  {spanish: "comercializar", english: "to market", example: {spanish: "Comercializamos nuestros productos en Europa.", english: "We market our products in Europe."}},
  {spanish: "promocionar", english: "to promote", example: {spanish: "Promocionamos el nuevo lanzamiento en redes sociales.", english: "We promoted the new launch on social media."}},
  
  // Advanced C1 verbs
  {spanish: "abarcar", english: "to encompass/cover", example: {spanish: "El informe abarca todos los aspectos del problema.", english: "The report covers all aspects of the problem."}},
  {spanish: "abordar", english: "to address/tackle", example: {spanish: "Abordaremos este tema en la próxima reunión.", english: "We will address this topic in the next meeting."}},
  {spanish: "acatar", english: "to comply with/obey", example: {spanish: "Debemos acatar las nuevas regulaciones.", english: "We must comply with the new regulations."}},
  {spanish: "acentuar", english: "to emphasize/accentuate", example: {spanish: "Acentuó la importancia de la puntualidad.", english: "He emphasized the importance of punctuality."}},
  {spanish: "acotar", english: "to limit/define boundaries", example: {spanish: "Acotaron el área de investigación.", english: "They defined the boundaries of the research area."}},
  {spanish: "aludir", english: "to allude to/refer to", example: {spanish: "Aludió a un incidente anterior sin nombrarlo.", english: "He alluded to a previous incident without naming it."}},
  {spanish: "atenuar", english: "to mitigate/attenuate", example: {spanish: "Medidas para atenuar los efectos del cambio climático.", english: "Measures to mitigate the effects of climate change."}},
  {spanish: "atribuir", english: "to attribute", example: {spanish: "Atribuyeron el éxito al trabajo en equipo.", english: "They attributed the success to teamwork."}},
  {spanish: "cuestionar", english: "to question", example: {spanish: "Cuestionaron la validez de los resultados.", english: "They questioned the validity of the results."}},
  {spanish: "decrecer", english: "to decrease", example: {spanish: "Las ventas decrecieron durante la crisis.", english: "Sales decreased during the crisis."}},
  {spanish: "denotar", english: "to denote/indicate", example: {spanish: "Su tono denotaba cierta preocupación.", english: "His tone indicated some concern."}},
  {spanish: "desempeñar", english: "to perform/carry out", example: {spanish: "Desempeña sus funciones con profesionalismo.", english: "He performs his duties professionally."}},
  {spanish: "destacar", english: "to highlight/stand out", example: {spanish: "Destacó los puntos principales de su investigación.", english: "He highlighted the main points of his research."}},
  {spanish: "discernir", english: "to discern/distinguish", example: {spanish: "Es difícil discernir la verdad en este caso.", english: "It's hard to discern the truth in this case."}},
  {spanish: "discrepar", english: "to disagree", example: {spanish: "Discrepamos en algunos puntos del contrato.", english: "We disagree on some points of the contract."}},
  {spanish: "disuadir", english: "to dissuade", example: {spanish: "Intenté disuadirlo de tomar esa decisión.", english: "I tried to dissuade him from making that decision."}},
  {spanish: "divulgar", english: "to disseminate/publish", example: {spanish: "Divulgamos los hallazgos en una revista científica.", english: "We published the findings in a scientific journal."}},
  {spanish: "ejercer", english: "to exercise/practice (profession)", example: {spanish: "Ejerce la medicina desde hace veinte años.", english: "He has practiced medicine for twenty years."}},
  {spanish: "enfatizar", english: "to emphasize", example: {spanish: "Enfatizó la necesidad de actuar rápido.", english: "He emphasized the need to act quickly."}},
  {spanish: "enmarcar", english: "to frame/contextualize", example: {spanish: "Enmarcó el debate dentro del contexto histórico.", english: "He framed the debate within the historical context."}},
  {spanish: "esbozar", english: "to sketch/outline", example: {spanish: "Esbozó un plan preliminar para el proyecto.", english: "He outlined a preliminary plan for the project."}},
  {spanish: "estimar", english: "to estimate/consider", example: {spanish: "Estimamos que el trabajo tomará tres meses.", english: "We estimate the work will take three months."}},
  {spanish: "evocar", english: "to evoke", example: {spanish: "La música evocó recuerdos de mi infancia.", english: "The music evoked memories of my childhood."}},
  {spanish: "fomentar", english: "to promote/encourage", example: {spanish: "Fomentamos la creatividad en nuestros empleados.", english: "We encourage creativity in our employees."}},
  {spanish: "indagar", english: "to investigate/inquire", example: {spanish: "Indagaron sobre las causas del accidente.", english: "They investigated the causes of the accident."}},
  {spanish: "incidir", english: "to affect/influence", example: {spanish: "Estos factores inciden directamente en los resultados.", english: "These factors directly affect the results."}},
  {spanish: "inferir", english: "to infer", example: {spanish: "Podemos inferir sus intenciones por sus acciones.", english: "We can infer his intentions from his actions."}},
  {spanish: "matizar", english: "to qualify/nuance", example: {spanish: "Matizó sus declaraciones para evitar malentendidos.", english: "He qualified his statements to avoid misunderstandings."}},
  {spanish: "plasmar", english: "to capture/express", example: {spanish: "Plasmó sus ideas en un ensayo brillante.", english: "He expressed his ideas in a brilliant essay."}},
  {spanish: "plantear", english: "to pose/raise (question)", example: {spanish: "Planteó una pregunta interesante al final.", english: "He raised an interesting question at the end."}},
  {spanish: "ponderar", english: "to weigh/consider carefully", example: {spanish: "Ponderamos todas las opciones antes de decidir.", english: "We carefully weighed all options before deciding."}},
  {spanish: "postergar", english: "to postpone/delay", example: {spanish: "Postergamos la reunión hasta la próxima semana.", english: "We postponed the meeting until next week."}},
  {spanish: "prescindir", english: "to do without/dispense with", example: {spanish: "Prescindimos de servicios innecesarios.", english: "We dispensed with unnecessary services."}},
  {spanish: "propugnar", english: "to advocate/defend", example: {spanish: "Propugna políticas medioambientales más estrictas.", english: "He advocates for stricter environmental policies."}},
  {spanish: "redundar", english: "to result in/redound", example: {spanish: "Esto redundará en beneficios para todos.", english: "This will result in benefits for everyone."}},
  {spanish: "relegar", english: "to relegate/sideline", example: {spanish: "Relegaron el asunto a un segundo plano.", english: "They relegated the matter to the background."}},
  {spanish: "soslayar", english: "to avoid/evade", example: {spanish: "Soslayó responder a la pregunta directa.", english: "He avoided answering the direct question."}},
  {spanish: "suscitar", english: "to provoke/raise", example: {spanish: "Sus comentarios suscitaron mucha polémica.", english: "His comments provoked much controversy."}},
  {spanish: "trascender", english: "to transcend", example: {spanish: "Su obra trasciende las barreras culturales.", english: "His work transcends cultural barriers."}},
  {spanish: "vislumbrar", english: "to glimpse/envision", example: {spanish: "Vislumbramos un futuro prometedor.", english: "We glimpsed a promising future."}}
],
